...
class Type {
    ...
    //hasProperty(obj,key) { return this.getPropertyNames(obj).includes(key) }
    hasProperty(obj,key) {
    ...
    hasMethod(obj,key) { return this.isIns(obj) && this.isFn(this._getDesc(obj,key).value) && !this.hasGS(obj,key) }
...
//    _getDesc(obj,key) { return Object.getOwnPropertyDescriptor(obj, key) }
    ...
    getStaticMethod(obj,key) {
        const m = this._getDesc(obj,key).value
        if (this.isCls(obj) && !this.isFn(m)) {return undefined}
        else if (this.isIns(obj) && !this.isFn(obj.constructor[key])) {return undefined}
        else { return m }
    }
    */
    ...
    hasOwnMethod(obj,key) { return this.isIns(obj) && this.isFn(this._getDesc(obj,key).value) }
    //hasOwnMethod(obj,key) { return this.isFn(this._getDesc(obj,key).value) && !this.hasOwnGetter(obj,key) && !this.hasOwnGetter(obj,key) }
    /*
    hasOwnMethod(obj,key) {
        console.log(this._getDesc(obj,key))
        console.log(this._getDesc(obj,key).value)
//        return this.hasOwnProperty(obj,key) && 
        return this.isFn(this._getDesc(obj,key).value) && !this.hasOwnGetter(obj,key) && !this.hasOwnGetter(obj,key)
    }
    */
    ...
    //hasOwnField(obj,key) { const p=Object.hasOwnProperty(obj, key); return p && !Type.isFn(p) }
    //hasOwnField(obj,key) { const p=obj.hasOwnProperty(key); return p && !this.isFn(obj.key) && !this._getOwnDesc(obj,key) }
    hasOwnField(obj,key) {
    ...
    //getOwnMethod(obj,key) { return Type.isIns(obj) && Object.getOwnPropertyNames(obj).includes(key) && Type.isFn(obj.key) ? obj.key : null }
    getOwnMethod(obj,key) { return Type.isIns(obj) && Object.getOwnPropertyNames(obj).includes(key) && Type.isFn(obj[key]) ? obj[key] : null }
    /*
    getOwnStaticMethod(obj,key) {
        if (Type.isCls(obj)) {return Object.getOwnPropertyNames(obj).includes(key) && Type.isFn(obj[key]) ? obj[key] : null}
        else if (Type.isIns(obj)) {
            const C = obj.constructor
            return Object.getOwnPropertyNames(C).includes(key) && Type.isFn(C[key]) ? obj[key] : null
        }
        return  && 
    }
    */
